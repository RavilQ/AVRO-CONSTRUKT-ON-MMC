...
// progres barin yanindaki data
  var eventData = {
    labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
    datasets: [{
            label: 'Critical',
            data: [50, 35, 15, 45, 35, 40, 25, 44, 20, 30, 38, 15],
            backgroundColor: [
              'rgba(	255, 131, 0)'
            ],
            borderColor: [
  ...
  var eventOptions = {
      ...
      tooltips: {
          backgroundColor: 'rgba(52, 171, 254, 1)',
      }
  };
...
// sales analiticts start
  var salesanalyticData = {
    labels: ["Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug"],
    datasets: [{
            label: 'test1',
            data: [18, 23, 22, 24, 26, 23, 28],
            borderColor: [
                '#3022cb'
            ],
            borderWidth: 5,
...
// card title 
  var barChartStackedData = {
    ...
    datasets: [{
      label: 'sold',
      data: [50,20,15,30,20,10,20,15,30,20, 10,20,],
      backgroundColor: [
        '#6fffdf',
        '#2b80ff',
        '#2b80ff',
    ...
    {
      label: 'Chrome',
      data: [15,25,10,20,30,5,25,10,20,30,25,10],
      backgroundColor: [
        '#bfccda',
        '#bfccda',
        '#bfccda',
  ...
  // maybe dark version of card title
  var barChartStackedDarkData = {
    labels: ["jan", "feb", "mar", "apr", "may", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
    datasets: [{
      label: 'Safari',
      data: [80,20,15,30,20,10,20,15,30,20, 10,20,],
      backgroundColor: [
        '#2b80ff',
        '#2b80ff',
        '#2b80ff',
...
// end
  ...
  if ($("#salesTopChart").length) {
    ...
    var salesTopData = {
        ...
        datasets: [{
            label: '# of Votes',
            data: [10, 79, 78, 65, 77, 68, 63, 73, 58, 46, 60, 65, 74, 72, 63, 54, 55, 64, 34, 46, 34, 35, 24, 64, 34, 23, 13, 54, 27, 43, 34, 43, 64, 50, 43, 55, 39, 43],
...
var eCommerceAnalyticData = {
  ...
  datasets: [{
          label: 'Critical',
          data: [26, 56, 55, 59, 59, 59, 57, 56, 57, 54, 56, 58, 57, 59, 58, 59, 57, 55, 56, 54, 52, 52, 50, 50, 50, 52, 48, 49, 50, 52, 53, 52, 55, 54, 53, 56, 55, 56, 55, 54, 55, 57, 58, 56, 55, 56, 57, 58, 59, 58, 57, 55, 53, 52, 55, 57, 55, 54, 52, 55, 57, 56, 57, 58, 59, 58, 59, 57, 56, 55, 57, 58, 59, 60, 62, 60, 59, 58, 57, 56, 57, 56, 58, 59],
          borderColor: [
              '#392ccd'
          ],
          borderWidth: 3,
          fill: true,
          backgroundColor:"rgba(242, 150, 247, .1)"
      },
      {
          label: 'Warning',
